...
- Name: Login >> Negative login >> login(T-10, 12345678) shows error
...
Call log:
  - waiting for locator('//p[@class=\'loginError login-errorT\']') to be visible

    at C:\Users\shalu\Desktop\FabHr\tests\fabHrTests\loginTest.spec.js:62:22
```
